...
import os
from Background import intro, about, team_analysis, dashboard, sentiment_analysis, clusters
...
page = st.sidebar.radio(
    "Navigate to:",
    ["Introduction", "About Us", "Team Analysis", "Dashboard", "Sentiment Analysis", "Clustering Analysis"]  # Add "Clustering Analysis"
)
...
elif page == "Sentiment Analysis":  # Existing block
    sentiment_analysis.sentiment_analysis_page()
elif page == "Clustering Analysis":  # Add this block
